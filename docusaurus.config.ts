...
const config: Config = {
  ...
  tagline:
    "All-in-one business management platform that helps you handle inventory, departments, and daily operations with real-time updates and notifications. ",
  favicon:
    "https://lh3.googleusercontent.com/p/AF1QipNdAaM1zzLbdDepo_pZKBHgKJZQKSd3QDXF4pOJ=s1360-w1360-h1020-rw",
  future: {
    v4: true,
  },
